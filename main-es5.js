...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _eventview_eventview_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./eventview/eventview.component */
    ...
    var routes = [{
      ...
      path: 'eventview',
      component: _eventview_eventview_component__WEBPACK_IMPORTED_MODULE_6__["EventviewComponent"]
    }];
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_config_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./service/config.service */
    "./src/app/service/config.service.ts");
    /* harmony import */


    var _service_event_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(router, loggy, configService, eventService) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function logOut() {
          this.loggy.info("--- logOut() button clicked ---"); // Removes all saved data from session

          var sessionKey = sessionStorage.getItem("email");
          this.loggy.info("sessionKey: " + sessionKey);
          sessionStorage.clear(); // Tests if key still remains

          var clearedKey = sessionStorage.getItem("email");
          this.loggy.info("clearedKey: " + clearedKey); // Routes
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterOutlet"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterLinkWithHref"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterLinkActive"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _eventview_eventview_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./eventview/eventview.component */
    "./src/app/eventview/eventview.component.ts");
    /* harmony import */


    var _service_config_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./service/config.service */
    "./src/app/service/config.service.ts");
    /* harmony import */


    var _service_event_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./service/event.service */
    "./src/app/service/event.service.ts");
    /* harmony import */


    var _service_password_encryption_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [_service_config_service__WEBPACK_IMPORTED_MODULE_12__["ConfigService"], _service_event_service__WEBPACK_IMPORTED_MODULE_13__["EventService"], _service_password_encryption_service__WEBPACK_IMPORTED_MODULE_14__["PasswordEncryptionService"]],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], ngx_logger__WEBPACK_IMPORTED_MODULE_5__["LoggerModule"].forRoot({
        serverLoggingUrl: 'http://localhost:9999/api/logs',
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_7__["RegisterComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_8__["LoginComponent"], _profile_profile_component__WEBPACK_IMPORTED_MODULE_9__["ProfileComponent"], _event_event_component__WEBPACK_IMPORTED_MODULE_10__["EventComponent"], _eventview_eventview_component__WEBPACK_IMPORTED_MODULE_11__["EventviewComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], ngx_logger__WEBPACK_IMPORTED_MODULE_5__["LoggerModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppClassEventEventTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Event = function Event(userEmail, eventID, eventName, eventDescription, eventLocation, dateTime, eventType) {
  ...
  /***/
  function srcAppClassUserUserTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var User = function User(id, email, password, firstName, lastName, contact) {
  ...
  function srcAppEventEventComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _class_event_event__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../class/event/event */
    "./src/app/class/event/event.ts");
    /* harmony import */
    ...
    var _service_event_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../service/event.service */
    "./src/app/service/event.service.ts");
    /* harmony import */
    ...
    var EventComponent = /*#__PURE__*/function () {
      function EventComponent(router, loggy, configService, eventService) {
      ...
      _createClass(EventComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sessionKey = sessionStorage.getItem("email");
          this.loggy.info("Current sessionKey: " + this.sessionKey); // Validates if key exists and routes accordingly
        ...
        value: function createEvent() {
          ...
          this.loggy.info("createEvent() clicked."); // Constructs an event object based on input values

          var eventName = document.getElementById("inputEventName").value;
          var eventDescription = document.getElementById("inputEventDescription").value;
          var eventLocation = document.getElementById("inputEventLocation").value;
          var dateTime = document.getElementById("inputDateTime").value;
          var eventType = document.getElementById("inputEventType").value;
          this.event = new _class_event_event__WEBPACK_IMPORTED_MODULE_1__["Event"](sessionStorage.getItem("email"), undefined, eventName, eventDescription, eventLocation, dateTime, eventType); // Sanity check

          this.loggy.info(this.event); // POSTs event to endpoint and routes to event view

          this.eventService.createEvent(this.event).subscribe(function (data) {
            return _this.router.navigate(["/eventview"]);
          });
        }
      }]);
    ...
    EventComponent.ɵfac = function EventComponent_Factory(t) {
      return new (t || EventComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_logger__WEBPACK_IMPORTED_MODULE_3__["NGXLogger"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_event_service__WEBPACK_IMPORTED_MODULE_5__["EventService"]));
    };
    ...
    EventComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function EventComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function EventComponent_Template_form_ngSubmit_8_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EventComponent_Template_input_ngModelChange_11_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EventComponent_Template_input_ngModelChange_14_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EventComponent_Template_input_ngModelChange_17_listener($event) {
            return ctx.event.eventLocation = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EventComponent_Template_input_ngModelChange_20_listener($event) {
            return ctx.event.dateTime = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EventComponent_Template_select_ngModelChange_23_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventComponent, [{
        ...
        return [{
          ...
          type: _service_event_service__WEBPACK_IMPORTED_MODULE_5__["EventService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppEventviewEventviewComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EventviewComponent", function () {
    ...
    function EventviewComponent_div_5_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventviewComponent_div_5_div_1_Template_button_click_27_listener() {
          ...
          return ctx_r4.deleteEvent(i_r2);
        });
    ...
    function EventviewComponent_div_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var EventviewComponent = /*#__PURE__*/function () {
      function EventviewComponent(router, loggy, eventService) {
        _classCallCheck(this, EventviewComponent);
      ...
      _createClass(EventviewComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this2 = this;
          ...
          // Grabs key from current session
          this.sessionKey = sessionStorage.getItem("email");
          this.loggy.info("Current sessionKeyL " + this.sessionKey); // Validates if key exists and routes accordingly

          if (this.sessionKey == null) {
            window.location.assign("/login");
          } else {
            this.eventService.getAllEvents().subscribe(function (data) {
              _this2.loggy.info("ALL EVENTS FROM DATABASE: ");

              for (var i in data) {
                _this2.loggy.info(data[i]);

                if (data[i].userEmail == sessionStorage.getItem("email")) {
                  _this2.events.push(data[i]);
                }
              }
            });
          }
        ...
        value: function deleteEvent(index) {
          ...
          this.loggy.info("--- deleteEvent() clicked ---"); // Assigns to local variable and passes it as an argument to backend

          this.tempID = this.events[index].eventID;
          this.loggy.info("Current index's eventID: " + this.events[index].eventID);
          this.eventService.deleteEventById(this.tempID).subscribe(function (data) {
            return _this3.event = data;
    ...
    EventviewComponent.ɵfac = function EventviewComponent_Factory(t) {
      return new (t || EventviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_logger__WEBPACK_IMPORTED_MODULE_3__["NGXLogger"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_event_service__WEBPACK_IMPORTED_MODULE_4__["EventService"]));
    };

    EventviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: EventviewComponent,
      selectors: [["app-eventview"]],
      decls: 6,
      vars: 1,
      consts: [[1, "container", "shadow", "bg-light", "p-2", "my-5"], [1, "container"], [1, "display-4", "text-center", "m-4"], [1, "container", "col-8"], [4, "ngFor", "ngForOf"], ["class", "card p-4 my-4 border-0 shadow", 4, "ngIf"], [1, "card", "p-4", "my-4", "border-0", "shadow"], ["hidden", ""], ["type", "button", 1, "btn", "btn-danger", 3, "click"]],
      template: function EventviewComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventviewComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _class_user_user__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../class/user/user */
    "./src/app/class/user/user.ts");
    /* harmony import */
    ...
    var _service_password_encryption_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../service/password-encryption.service */
    "./src/app/service/password-encryption.service.ts");
    /* harmony import */
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(router, loggy, configService, encryptionService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          ...
          this.loggy.info("--- login() button pressed ---"); // Constructs a user object based on input values
          ...
          this.loggy.info(user); // Validates and routes accordingly

          this.configService.login(user).subscribe(function (data) {
            _this4.loggy.info("USER FROM DATABASE: ");

            _this4.loggy.info(data);

            if (data != null) {
              _this4.loggy.info("Successful login."); // Saves data (email) to a session


              sessionStorage.setItem("email", email);
              var sessionKey = sessionStorage.getItem("email");

              _this4.loggy.info("Stored key: " + sessionKey); // Route


              window.location.assign("/eventview");
            } else {
              _this4.loggy.error("Failed login.");
    ...
    LoginComponent.ɵfac = function LoginComponent_Factory(t) {
      return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_logger__WEBPACK_IMPORTED_MODULE_3__["NGXLogger"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_password_encryption_service__WEBPACK_IMPORTED_MODULE_5__["PasswordEncryptionService"]));
    };
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 27,
      vars: 7,
      consts: [[1, "container-fluid"], [1, "row", "no-gutter"], [1, "col-md-6", "d-none", "d-md-flex", "bg-image"], [1, "col-md-6", "bg-light"], [1, "login", "d-flex", "align-items-center"], [1, "container"], [1, "row"], [1, "col-8", "mx-auto"], [1, "display-4"], [3, "ngSubmit"], ["thisForm", "ngForm"], [1, "form-group"], ["name", "inputEmail", "id", "inputEmail", "type", "email", "placeholder", "Email address", "pattern", "^\\w+@[a-zA-Z_]+?\\.[a-zA-Z]{2,3}$", "required", "", 1, "form-control", "rounded-pill", "border-0", "shadow", "my-3", "px-4", 3, "ngModel", "ngModelChange"], ["email", "ngModel"], ["class", "alert alert-danger rounded-pill border-0 shadow m-1 p-1 text-center text-muted", 4, "ngIf"], ["name", "inputPassword", "id", "inputPassword", "type", "password", "placeholder", "Password", "required", "", 1, "form-control", "rounded-pill", "border-0", "shadow", "my-3", "px-4", 3, "ngModel", "ngModelChange"], ["password", "ngModel"], ["type", "submit", 1, "btn", "btn-primary", "btn-block", "text-uppercase", "rounded-pill", "border-0", "shadow", "mt-4", 3, "disabled"], [1, "text-center", "justify-content-between", "mt-4"], ["routerLinkActive", "router-link-active", 1, "font-italic", "text-muted", 3, "routerLink"], [1, "alert", "alert-danger", "rounded-pill", "border-0", "shadow", "m-1", "p-1", "text-center", "text-muted"], [4, "ngIf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
        ...
        return [{
          ...
          type: _service_password_encryption_service__WEBPACK_IMPORTED_MODULE_5__["PasswordEncryptionService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfileComponent = /*#__PURE__*/function () {
      function ProfileComponent(router, loggy, configService) {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.sessionKey == null) {
            ...
            this.configService.getUserByEmail(this.sessionKey).subscribe(function (data) {
  ...
  function srcAppRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RegisterComponent = /*#__PURE__*/function () {
      function RegisterComponent(router, loggy, configService, encryptionService) {
        ...
        this.configService = configService;
        this.encryptionService = encryptionService;
        this.user = new _class_user_user__WEBPACK_IMPORTED_MODULE_1__["User"](undefined, undefined, undefined, undefined, undefined, undefined); // TESTING NGXLOGGER MESSAGES
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function register() {
          ...
          this.loggy.info("--- register() button pressed ---"); // Constructs a user object based on input values
          ...
          this.configService.createUser(user).subscribe(function (data) {
            _this6.loggy.info("USER FROM DATABASE: ");

            _this6.loggy.info(data);

            if (data != null) {
              _this6.loggy.info("Registration success."); // Saves data (email) to a session


              sessionStorage.setItem("email", email);
              var sessionKey = sessionStorage.getItem("email");

              _this6.loggy.info("Stored key: " + sessionKey); // Route


              window.location.assign("/profile");
            } else {
              _this6.loggy.error("Registration failed.");
  ...
  function srcAppServiceConfigServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var ConfigService = /*#__PURE__*/function () {
      ...
      function ConfigService(http, loggy) {
        _classCallCheck(this, ConfigService);

        this.http = http;
        this.loggy = loggy; // Custom HTTP options to throw into CRUD operations
    ...
    ConfigService.ɵfac = function ConfigService_Factory(t) {
      return new (t || ConfigService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ngx_logger__WEBPACK_IMPORTED_MODULE_2__["NGXLogger"]));
    };
  ...
  function srcAppServiceEventServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var EventService = /*#__PURE__*/function () {
      // Boots HttpClient upon creation
      function EventService(http, loggy) {
    ...
    EventService.ɵfac = function EventService_Factory(t) {
      return new (t || EventService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ngx_logger__WEBPACK_IMPORTED_MODULE_2__["NGXLogger"]));
    };
  ...
  /***/
  function srcAppServicePasswordEncryptionServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PasswordEncryptionService", function () {
    ...
    /*! ngx-logger */
    "./node_modules/ngx-logger/__ivy_ngcc__/fesm2015/ngx-logger.js"); // import { SSL_OP_SSLEAY_080_CLIENT_DH_BUG } from 'constants';
    ...
    */
    ...
    var PasswordEncryptionService = /*#__PURE__*/function () {
      function PasswordEncryptionService(loggy) {
        _classCallCheck(this, PasswordEncryptionService);

        this.loggy = loggy;
      }

      _createClass(PasswordEncryptionService, [{
        key: "encrypt",
    ...
    PasswordEncryptionService.ɵfac = function PasswordEncryptionService_Factory(t) {
      return new (t || PasswordEncryptionService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ngx_logger__WEBPACK_IMPORTED_MODULE_1__["NGXLogger"]));
    };

    PasswordEncryptionService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: PasswordEncryptionService,
      factory: PasswordEncryptionService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PasswordEncryptionService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\CodeHome\prodFiles3\revature_p2\gatherup-frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
