...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_password_encryption_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./service/password-encryption.service */
    "./src/app/service/password-encryption.service.ts"); // enables form features for app
  ...
  function srcAppClassUserUserTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var User = function User(email, password, firstName, lastName, contact) {
  ...
  function srcAppEventEventComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    EventComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 34,
      vars: 0,
      consts: [["id", "box", 1, "container", "p-2"], [1, "jumbotron", "m-4"], [1, "row"], [1, "col-8"], ["src", "https://w.wallhaven.cc/full/2e/wallhaven-2evd36.jpg", "alt", "Event Image", "width", "100%", 1, "img-fluid", "m-4"], [1, "col-4"], [1, "m-4"]],
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(service, router, encryptionService) {
        _classCallCheck(this, LoginComponent);

        this.service = service;
        this.router = router;
        this.encryptionService = encryptionService; // Complains if this is removed, dunno why tbh
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          console.log("Login button pressed."); // Constructs a user object to validate credentials

          var email = document.getElementById("inputEmail").value;
          var password = document.getElementById("inputPassword").value;
          this.user = new _class_user_user__WEBPACK_IMPORTED_MODULE_1__["User"](email, this.encryptionService.encrypt(password), undefined, undefined, undefined); // Sanity check

          console.log(this.user); // Validates against hard-coded credentials
    ...
    LoginComponent.ɵfac = function LoginComponent_Factory(t) {
      return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_config_service__WEBPACK_IMPORTED_MODULE_2__["ConfigService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_password_encryption_service__WEBPACK_IMPORTED_MODULE_4__["PasswordEncryptionService"]));
    };
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 26,
      vars: 6,
      consts: [[1, "container-fluid"], [1, "row", "no-gutter"], [1, "col-md-6", "d-none", "d-md-flex", "bg-image"], [1, "col-md-6", "bg-light"], [1, "login", "d-flex", "align-items-center"], [1, "container"], [1, "row"], [1, "col-lg-10", "col-xl-8", "mx-auto"], [1, "display-4"], [1, "form-group"], ["name", "inputEmail", "id", "inputEmail", "type", "email", "placeholder", "Email address", "required", "", 1, "form-control", "rounded-pill", "border-0", "shadow", "my-3", "px-4", 3, "ngModel", "ngModelChange"], ["email", "ngModel"], ["class", "alert alert-danger rounded-pill border-0 shadow m-1", 4, "ngIf"], ["name", "inputPassword", "id", "inputPassword", "type", "password", "placeholder", "Password", "required", "", 1, "form-control", "rounded-pill", "border-0", "shadow", "my-3", "px-4", 3, "ngModel", "ngModelChange"], ["password", "ngModel"], ["type", "submit", 1, "btn", "btn-primary", "btn-block", "text-uppercase", "rounded-pill", "border-0", "shadow", "mt-4", 3, "click"], [1, "text-center", "justify-content-between", "mt-4"], ["routerLinkActive", "router-link-active", 1, "font-italic", "text-muted", 3, "routerLink"], [1, "alert", "alert-danger", "rounded-pill", "border-0", "shadow", "m-1"], [4, "ngIf"]],
  ...
  function srcAppProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_config_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../service/config.service */
    "./src/app/service/config.service.ts");
    /* harmony import */
    ...
    ProfileComponent.ɵfac = function ProfileComponent_Factory(t) {
      return new (t || ProfileComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_config_service__WEBPACK_IMPORTED_MODULE_1__["ConfigService"]));
    };
    ...
    ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 1,
      consts: [[1, "container"], [1, "card"], [1, "card-body"], [1, "text-left"], [4, "ngFor", "ngForOf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfileComponent, [{
        ...
        return [{
          type: _service_config_service__WEBPACK_IMPORTED_MODULE_1__["ConfigService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var RegisterComponent = /*#__PURE__*/function () {
      function RegisterComponent(service, router, encryptionService) {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function register() {
          ...
          this.user = new _class_user_user__WEBPACK_IMPORTED_MODULE_1__["User"](email, this.encryptionService.encrypt(password), firstName, lastName, contact); // Sanity check

          console.log(this.user); // POSTs constructed user to endpoint and routes to the profile view

          this.service.createUser(this.user).subscribe(function (data) {
            return _this2.router.navigate(["/profile"]);
    ...
    var ConfigService = /*#__PURE__*/function () {
      ...
      _createClass(ConfigService, [{
        ...
        value: function setUrl(id) {
          this.rmUrl = "https://rickandmortyapi.com/api/character/".concat(id);
        }
      }, {
        key: "getRickMorty",
        value: function getRickMorty() {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\CodeHome\rev\revature_p2\gatherup-frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
